...
class LoadOut(MonopileState):
    def __init__(self, vessel, fabrication_yard, monopile_transport_schedule):
        super().__init__(vessel, fabrication_yard, monopile_transport_schedule)

class AvailableForLoadOut(MonopileState):
    def __init__(self, vessel, fabrication_yard, monopile_transport_schedule):
        super().__init__(vessel, fabrication_yard, monopile_transport_schedule)

class DirectShipment(MonopileState):
    def __init__(self, vessel, fabrication_yard, monopile_transport_schedule):
        super().__init__(vessel, fabrication_yard, monopile_transport_schedule)

class TransitToMarshallingYard(MonopileState):
    def __init__(self, vessel, fabrication_yard, monopile_transport_schedule):
        super().__init__(vessel, fabrication_yard, monopile_transport_schedule)

class LoadInMarshallingYard(MonopileState):
    def __init__(self, vessel, fabrication_yard, monopile_transport_schedule):
        super().__init__(vessel, fabrication_yard, monopile_transport_schedule)

class LoadOutMarshallingYard(MonopileState):
    def __init__(self, vessel, fabrication_yard, monopile_transport_schedule):
        super().__init__(vessel, fabrication_yard, monopile_transport_schedule)

class Feedering(MonopileState):
    def __init__(self, vessel, fabrication_yard, monopile_transport_schedule):
        super().__init__(vessel, fabrication_yard, monopile_transport_schedule)

class Discharge(MonopileState):
    def __init__(self, vessel, fabrication_yard, monopile_transport_schedule):
        super().__init__(vessel, fabrication_yard, monopile_transport_schedule)

class Start(MonopileState):
    # Dummy node to represent the start 
    def __init__(self, vessel, fabrication_yard, monopile_transport_schedule):
        super().__init__(vessel, fabrication_yard, monopile_transport_schedule)

class End(MonopileState):
    # Dummy node to represent the end of the process
    def __init__(self, vessel, fabrication_yard, monopile_transport_schedule):
        super().__init__(vessel, fabrication_yard, monopile_transport_schedule)
...
class TransferToQuaySite(MonopileStateTransition):
    def __init__(self, dependency_type: str = 'afterEnd'):
        self.dependency_type = dependency_type

class Sailing(MonopileStateTransition):    
    def __init__(self, dependency_type: str = 'afterEnd'):
        self.dependency_type = dependency_type

class Transfer(MonopileStateTransition):
    def __init__(self, dependency_type: str = 'afterEnd'):
        self.dependency_type = dependency_type

class ArrivalAtArgentia(MonopileStateTransition):
    def __init__(self, dependency_type: str = 'afterEnd'):
        self.dependency_type = dependency_type

class Marshalling(MonopileStateTransition):
    def __init__(self, dependency_type: str = 'afterEnd'):
        self.dependency_type = dependency_type

class PrepareForFeedering(MonopileStateTransition):
    pass

class Initiate(MonopileStateTransition):
    pass

class Terminate(MonopileStateTransition):
    pass