...
from lmlib.schemas.base_model import (Area, Equipment, EquipmentCapability,
                                      EquipmentCapabilityProperty,
                                      OperationalLocation,
                                      ParameterSpecification, PhysicalAsset,
                                      SpatialDefinition, StorageZone,
                                      WorkflowSpecification,
                                      WorkflowSpecificationNode, WorkSchedule)
...
class MonopileStateTransition(WorkflowSpecification):
    ...
    model_id: str = Field(
        "dtmi:digitaltwins:isa95:MonopileStateTransition;1", Literal=True
    )
...
class MonopileTransportSchedule(WorkSchedule):
    ...
    model_id: str = Field(
        "dtmi:digitaltwins:isa95:MonopileTransportSchedule;1", Literal=True
    )
    monopile: Monopile
...
class Availability(EquipmentCapabilityProperty):
    id: str
    value: str
    value_unit_of_measure: str